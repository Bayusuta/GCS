...
function addMissionRow(){
    ...
    $("#tbody-mission-list").append(
        `<tr>
            ...
            <td><input type="text" id="textbox-lon" style="border:none; width:100%;" disabled="true" value="104.123"/></td>
            <td><input type="text" id="textbox-lat" style="border:none; width:100%;" disabled="true" value="53.12"/></td>
            <td>70</td>
            <td>0.00</td>
            <td>387.2</td>
            <td>
